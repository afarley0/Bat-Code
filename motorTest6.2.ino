//This is to be run with the matlab program "arduinoInterface0_2.m"
...
void setup() {
  ...
  stepper_1.setMaxSpeed(5500);
  stepper_1.setAcceleration(1500);
  stepper_2.setMaxSpeed(5500);
  stepper_2.setAcceleration(1500);
  stepper_3.setMaxSpeed(5500);
  stepper_3.setAcceleration(1500);
  stepper_4.setMaxSpeed(5500);
  stepper_4.setAcceleration(1500);
  stepper_5.setMaxSpeed(5500);
  stepper_5.setAcceleration(1500);
...
void loop() {
  ...
  if (Serial.available() > 0){
    ...
    if (go.equals("go"))
    {
      noseSteps = Serial.parseInt();
      Serial.println(noseSteps);
      earSteps = Serial.parseInt();
      Serial.println(earSteps);
    ...
    while (digitalRead(52) == HIGH){
      if (runs){
        neoDynamicControl(1, noseSteps,earSteps);
        runs = false;
      }
